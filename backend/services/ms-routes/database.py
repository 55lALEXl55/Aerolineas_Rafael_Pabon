"""
database.py — Conexiones para ms-routes
"""
import os
...
engine1 = create_engine(DB1_URL, pool_pre_ping=True, pool_size=3)
engine2 = create_engine(DB2_URL, pool_pre_ping=True, pool_size=3)
