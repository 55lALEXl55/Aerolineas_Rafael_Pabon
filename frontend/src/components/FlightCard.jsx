    ...
    >
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div className="text-center">
            ...
            <div className="text-xs text-slate-400">{epochToTime(flight.departure_epoch)}</div>
          </div>
          <div className="flex-1 flex flex-col items-center">
            ...
            {flight.stopover ? (
              <div className="text-xs text-amber-400">via {flight.stopover}</div>
            ) : (
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-slate-400">{epochToTime(flight.arrival_epoch)}</div>
          </div>
        </div>
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 text-xs">
          ...
          <span className="text-white">{epochToTime(flight.departure_epoch)}</span>
          <ArrowRight className="w-3 h-3 text-slate-500" />
          <span className="text-white">{epochToTime(flight.arrival_epoch)}</span>
        </div>
      </div>
    </div>
  )
