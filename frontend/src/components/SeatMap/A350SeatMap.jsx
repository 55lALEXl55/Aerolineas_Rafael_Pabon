...
// A350-900: 262 asientos
// Primera clase: filas 1-2, 2-2-2 (AB | CD | EF)
// Turista: filas 4-31, 3-3-3 (ABC | DEF | GHJ)
...
export default function A350SeatMap({ seatMap, onSeatClick }) {
  const firstRows = [1, 2]
  const ecoRows = Array.from({ length: 28 }, (_, i) => i + 4)
